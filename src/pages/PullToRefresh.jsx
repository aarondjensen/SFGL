...
//
// Wave I cleanup: removed the dead `onRefresh` prop. It used to be a callback
// for in-place Firestore refetches but that approach didn't pick up new code
// from Vercel deploys, so we switched to full reload. The prop has been
// unused for several waves; now removed entirely.
// ============================================================================
